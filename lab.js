...
//Code Here
const {color: tacomaColor} = carDetails
const {make: tacomaMake} = carDetails
const {model: tacomaModel} = carDetails
const {year: tacomaYear} = carDetails
